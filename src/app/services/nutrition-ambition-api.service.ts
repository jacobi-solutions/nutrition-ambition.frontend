...
export interface INutritionAmbitionApiService {
     ...
     * @return Success
     */
    mockStreamBanana(body: RunChatRequest | undefined): Observable<void>;
    /**
     * @param body (optional) 
     * @return Success
     */
...
export class NutritionAmbitionApiService implements INutritionAmbitionApiService {
     ...
     */
    mockStreamBanana(body: RunChatRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Conversation/MockStreamBanana";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMockStreamBanana(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMockStreamBanana(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processMockStreamBanana(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
